...
| Phase 1: Core Agent Infrastructure | #35 | closed |
| Phase 2: Preset Agent Support | #36 | closed |
| Phase 3: Core Agent Content | #37 | closed |
| Phase 4: Preset Agent Content | #38 | closed |
| Phase 5: Smoke Test Extensions | #39 | closed |
| Phase 6: Orchestrator Doc Updates | #40 | closed |

## Log

- 2026-03-22: Phase 1 (brainstorm) — PRD created as #34
