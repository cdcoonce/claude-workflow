...
3. **For PreToolUse**: What conditions should block the tool call? What message should the user see?
4. **For PostToolUse**: What commands or actions should run? Should it report what it did?
